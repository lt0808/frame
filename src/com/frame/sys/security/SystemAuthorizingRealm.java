...
package com.frame.sys.security;
...
import com.frame.sys.controller.LoginController;
import com.frame.sys.entity.User;
import com.frame.sys.service.SystemService;
import com.frame.sys.servlet.ValidateCodeServlet;
...
public class SystemAuthorizingRealm extends AuthorizingRealm {
	...
	protected AuthorizationInfo doGetAuthorizationInfo(PrincipalCollection principals) {
		...
		if (user != null) {
			...
			info.addStringPermissions(UserUtils.getUserPermissions());
